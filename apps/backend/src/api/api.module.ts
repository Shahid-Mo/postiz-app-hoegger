...
// import { McpService } from '@gitroom/nestjs-libraries/mcp/mcp.service';  // DISABLED
// import { McpController } from '@gitroom/backend/api/routes/mcp.controller';  // DISABLED
